            ...
            <div class="nav-items">
                {{-- <ul>
                 ...
                 <ul>
                    ...
                    <li><a href="{{ route('newproduct') }}" class="{{ Request::is('pages/newproduct') ? 'active' : '' }}">@lang('public.PRODUCTS')</a></li>
                    <li><a href="{{ route('work') }}" class="{{ Request::is('pages/work') ? 'active' : '' }}">@lang('public.WORK')</a></li>
                    <li><a href="{{ route('why') }}" class="{{ Request::is('pages/why') ? 'active' : '' }}">@lang('public.WHY')</a></li>
