...
<div class="articlenews">
	<div class="wrappernews">
	  ...
	  <div class="wrapperText">
		<img class="newsimg" src="{{asset('images/imageslogo.png')}}" alt="picture" loading="lazy">

		<h1>

		  <mark>تم عقد اتفاقيه عمل مع شركات محليه</mark>
		</h1>
	  ...
	  <div class="articleText">
		<h4 class="introduction">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vel voluptatibus distinctio explicabo cum nostrum quisquam numquam sint alias, optio nam molestiae perferendis atque sed aliquam? Rerum aperiam asperiores minima obcaecati.</h4>
		<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae non atque molestias voluptatem quos! Quas soluta iure in, distinctio adipisci iusto at consequatur ad eaque quod vel asperiores. Quas, consequuntur? Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod eaque aspernatur consequuntur eligendi nobis facilis delectus atque, dolorem corporis quidem voluptates unde. Incidunt maiores unde aliquam mollitia aspernatur dolorem omnis!</p>
